                    ...
                    >
                      ...
                      {!selectMode && (
                        <div
                          ...
                          className="absolute top-1.5 start-1.5 w-6 h-6 bg-black/60 hover:bg-red-600 rounded-full items-center justify-center text-white transition-colors opacity-0 group-hover:opacity-100 flex cursor-pointer"
                        >
